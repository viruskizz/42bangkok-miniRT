...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/08 20:22:55 by sharnvon          #+#    #+#             */
/*   Updated: 2023/03/09 03:33:11 by sharnvon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sphere_initialise(t_data *data, char **object)
{
	...
	sphere->itrans = mtx_inverse(sphere->mtrans, 4, -1, 0);
	if (index != 4)
...
/*
* [function checking intersection point of scean and sphere]
