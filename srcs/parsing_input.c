...
/*
TODO debuging fuction
*/

void	printTwoArray(char **str);
void	printVector(t_vtr vector);
...
/*
* [function changing string into t_colour value]
...
/*
* [debuging function printing t_data value]
*/
void	print_data(t_data *data)
{
	...
	while(head != NULL)
	{
		...
		if (object->type == SPHERE)
		{
			...
			printf("\033[30m\033[33m|\033[0;30m • normalize : x[%f],y[%f],z[%f] [unuse]\033[0;32m\n", object->norm.x, object->norm.y, object->norm.z);
			printf("\033[33m|\033[0;32m • size      : h[%f],w[%f],d[%f]\n", object->size.h, object->size.w, object->size.d);
		...
		else if (object->type == PLANE)
		{
			...
			printf("\033[33m|\033[0;32m • coordinete: x[%f],y[%f],z[%f]\n", object->pos.x, object->pos.y, object->pos.z);
			printf("\033[33m|\033[0;32m • normalize : x[%f],y[%f],z[%f]\n", object->norm.x, object->norm.y, object->norm.z);
			printf("\033[30m\033[33m|\033[0;30m • size      : h[%f],w[%f],d[%f] [unuse]\033[0;32m\n", object->size.h, object->size.w, object->size.d);
			printf("\033[33m|\033[0;32m • color     : r[%d],g[%d],b[%d]\n", object->color.r, object->color.g, object->color.b);
		}
		else if (object->type == CYLIND)
		{
			printf("\033[33m=============== [object %d][cylinder] =================\033[0;32m\n", index++);
			printf("\033[33m|\033[0;32m • index     : %d\n", object->idx);
			printf("\033[33m|\033[0;32m • type      : %d\n", object->type);
			printf("\033[33m|\033[0;32m • name      : %s\n", object->name);
			printf("\033[33m|\033[0;32m • coordinete: x[%f],y[%f],z[%f]\n", object->pos.x, object->pos.y, object->pos.z);
